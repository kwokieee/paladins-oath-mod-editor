export default function RewardsEditor({ moduleDescriptor }) {
  return (
    <div>
      ...
      <input
        type='text'
        placeholder={'string. Reward name (not localized) to be displayed when the rewards are distributed.'}
      ...
      <input
        type='number'
        placeholder={'(Optional) int (AND=0 | OR=1) [default=AND(0)]. Determines how the reward options are given to the player.'}
        defaultValue={moduleDescriptor?.guid} 
      />
